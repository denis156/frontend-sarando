<template>
  <div ref="containerRef" class="w-full h-full relative">
    <div
      v-if="!webglSupported || isLoading"
      class="absolute inset-0 w-full h-full bg-linear-to-b from-neutral-900 via-neutral-900 to-black z-[-1] transition-opacity duration-500"
      :class="{
        'opacity-100': !webglSupported || isLoading,
        'opacity-0': webglSupported && !isLoading,
      }"
    ></div>
  </div>
</template>
