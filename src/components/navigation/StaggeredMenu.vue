    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            ref="iconRef"
            class="inline-flex relative justify-center items-center w-3.5 h-3.5 sm-icon shrink-0 will-change-transform"
            aria-hidden="true"
          >
            <span
              ref="plusHRef"
              class="top-1/2 left-1/2 absolute bg-current rounded-[2px] w-full h-0.5 -translate-x-1/2 -translate-y-1/2 sm-icon-line will-change-transform"
            />
            <span
              ref="plusVRef"
              class="top-1/2 left-1/2 absolute bg-current rounded-[2px] w-full h-0.5 -translate-x-1/2 -translate-y-1/2 sm-icon-line sm-icon-line-v will-change-transform"
            />
          </span>
        </button>
      </header>
            ...
            >
              ...
              >
                <a
                  ...
                  class="inline-block relative py-0.5 font-medium text-[#111] text-[1.2rem] no-underline transition-[color,opacity] duration-300 ease-linear sm-socials-link"
                >
                  {{ social.label }}
                </a>
              </li>
...
.sm-scope .sm-panel-item.router-link-exact-active {
  color: var(--sm-accent, #ff0000);
  font-weight: 700;
}
